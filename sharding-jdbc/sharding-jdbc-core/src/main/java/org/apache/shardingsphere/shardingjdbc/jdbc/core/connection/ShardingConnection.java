 ...
 * Connection that support sharding.
 ShardingConnection 主要是将创建 ShardingStatement 和 ShardingPreparedStatement 两个对象，主要的执行逻辑都在 Statement 对象中。
 当然 ShardingConnection 还有两个重要的功能，一个是获取真正的数据库连接，一个是事务提交功能
 */
@Getter
